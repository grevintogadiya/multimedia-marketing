...
export default function About() {
  return (
    <section
      id="about"
      className=" bg-white py-12 sm:py-16 md:py-20 lg:py-24  from-white to-blue-50"
    >
    ...
    "
          ...
          <div className="text-left">
            ...
            <p className="text-gray-600 mt-4 sm:mt-6 text-sm sm:text-base md:text-lg leading-relaxed sm:leading-7">
              Multimedia Marketing is a results-driven digital marketing agency.
              We help startups, local businesses and eCommerce brands grow with
            ...
            <div className="mt-6 sm:mt-8 space-y-5 sm:space-y-6">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1 sm:mt-2 text-sm sm:text-base">
                    We build strategies that generate quality leads, increase
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              <StatCard number="50+" title="Projects" />

              <StatCard number="100+" title="Clients" />

              <StatCard number="99%" title="Satisfaction" />
            </div>
          </div>
        </div>
      </div>
